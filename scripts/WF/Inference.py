...
df_meta = pd.read_csv(r"C:\Users\npotu1\DataScience\DeepAPL\Data\master.csv")#pd.read_csv('../../Data/master.csv')
...
DAPL_train.Y = OneHotEncoder(sparse_output=False).fit_transform(DAPL_train.Y.reshape(-1,1)) ## changes sparse to sparse_output
