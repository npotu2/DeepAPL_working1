...
##New line added
#df_promy_tc = df_promy['Patient']
##End
#df_promy_tc['count'] = df_promy['Patient'].value_counts().to_frame()
...
print(df_pro)
#print(df_pro['Patient'])

df_pro['Pro_Prop'] = df_pro['Pro']/df_pro['count'] ##Changed from patient to count
