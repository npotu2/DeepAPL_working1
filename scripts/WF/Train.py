...
data = 'load_data'
## np comments
# Assigning different values to same variables not sure why
# are we supposed use name ex: discovery_blasts based on the usecase and comment other name variable?
...
df_meta = pd.read_csv(r"C:\Users\npotu1\DataScience\DeepAPL\Data\master.csv")
